      ...
      >
        <Col lg={6} style={{ padding: '0px' }}>
          ...
          <p className='about-text mb-3 mb-md-0'>
            ...
            that my family often did.
            <br />
            As my interest grew along with my ambition to further my career in
            web development, I applied to DevMountain a coding boot camp in
            Lehi, Utah. There, I studied full stack development using the
            following technologies Postgres, Node, React, Express and Redux.
            After a fulfilling 3 months, I recently graduated with the honor of
            winning the best technology award for my personal project, ready to
            enter the field of web development with a new set of skills and
            knowledge I hadn't had before. I am currently in New York seeking my
            next endeavor in web programming.
          </p>
        </Col>
        <Col lg={6} style={{ padding: '0px' }}>
