...
import calculatorCover from '../assets/projectImages/calculatorCover.jpg'
...
const useAllProjects = () => {
  return shuffle([
    ...
    },
    {
      ...
      title: 'devquiz',
      text:
        'Test your JavaScript and Front-End knowledge with Dev Quiz: a web based quiz app, built to test your front-end skill. Users are able to pick a quiz from a variety of Front-End focused subjects. Users also have the ability to toggle styling from light mode to dark mode.',
    ...
    },
    {
      ...
      title: 'calculator',
      text:
        'A web-based alternative for a traditional calculator. Users are able to enter and calculate simple mathematical expressions. Entered values are validated and if an error is detected a syntax error pop-up is displayed.',
      stack: ['jQuery', 'bootstrap', 'node / express'],
    },
    {
      image: notepad,
      ...
      title: 'notepad',
      text:
        'A desktop notepad application developed using Java. Users are able to create, overwrite and save txt files locally on their computer. This app features a traditional edit section with copy, paste, cut, undo and redo actions. Entered text is proecessed to get word count and sentence count values along with a few other metrics which feed into a text complexity algorithm which outputs a Flesch text complexity score.',
      stack: ['java', 'jswing'],
    },
  ])
}
